...
from .import views
from workflowapp.views import get_employer_name, landing, deed_record,DeedsDetailView
...
urlpatterns = [
    ...
    path('deed/', views.deed_record, name='deed'),
    path('deedsview/', views.view_deeds, name='deedsview'),
    path('deeds/<int:id>/', views.employer_deeds, name='deeddetail'),
    path("deeds/rev_deed/<int:id>/", views.deed_review, name="rev_deed"),
    path("deed_sup_review/", views.deeds_supervisor_review, name="deed_sup_review"),
    path("deed_sup_review/rev_deed/<int:id>/", views.deed_review, name="sup_rev_deed"),
    path('delete_deeds/', views.delete_deeds, name='delete_deeds'),

    

    path('get_team_leader/', views.get_team_leader, name='get_team_leader'),

    #path('viewdeed/', views.DeedsDetailView,  name='deed-detail'),
